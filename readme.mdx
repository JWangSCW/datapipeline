...
- A [Scaleway Kapsule cluster](https://www.scaleway.com/en/docs/kubernetes/quickstart/) with Airflow installed
- A [Managed PostgreSQL instance](https://www.scaleway.com/en/docs/managed-databases-for-postgresql-and-mysql/quickstart/)
- A [Managed ClickHouse instance](https://www.scaleway.com/en/docs/data-warehouse/quickstart/)
